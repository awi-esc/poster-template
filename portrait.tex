...
\title{\LARGE An AWI color themed poster template}

\author{Author1 \inst{1,2,3} \and Author2 \inst{3,4,5}}

\institute[shortinst]{\inst{1} Alfred-Wegener Institute, Germany. \samelineand  \inst{2} University of Fun, Norway. \samelineand  \inst{3} University of Love, Norway. \\ \samelineand\inst{4} University of Ethics, Germany. \samelineand  \inst{5}  University of Food, UK.}
...
\footercontent{
  ...
  ABC Conference 2026, Potsdam --- XYZ-1234 \hfill
  \href{mailto:your.name@awi.de}{your.name@awi.de}}
...
\addtobeamertemplate{headline}{}
{
    ...
    %left
      ...
      {\includegraphics[height=5.5cm]{logos/_AWI-ESC_logo_main_white.pdf}}; 
      %right
      \node [anchor=north east, inner sep=3cm] at ([xshift=-1.0cm,yshift=1.2cm]current page.north east)
      {\includegraphics[height=2.cm]{logos/helmholtz_logo_white.pdf}};
    \end{tikzpicture}
}
%\vspace*{ 1cm }
\begin{frame}[t]
