...
\title{ An AWI color themed poster template}
...
\addtobeamertemplate{headline}{}
{
    ...
    %left
      ...
      {\includegraphics[height=5cm]{logos/logo_long_whitegrey.pdf}}; 
      %right
      \node [anchor=north east, inner sep=3cm] at ([xshift=-1.0cm,yshift=1.cm]current page.north east)
      {\includegraphics[height=3cm]{logos/helmholtz_logo_white.pdf}};
    \end{tikzpicture}
}
\begin{frame}[t]
\begin{columns}[t]
